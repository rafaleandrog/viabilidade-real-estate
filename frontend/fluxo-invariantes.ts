...
export function validarFunding(
  ...
  for (const s of calc.operacoes) {
    ...
    if (s.operacao.tipo === 'equity') {
      ...
      // (`funding-motor.ts:489`) um `resultadoFinal` negativo produz saída
      // negativa sem clamp. No modo progressivo (`funding-motor.ts:454-501`, decisão #432)
  ...
  // equity em modo `permuta_financeira` — o default de `funding-motor.ts:452`
