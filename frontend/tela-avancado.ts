...
const SUBABAS: Partial<Record<AbaTopo, SubAba[]>> = {
  ...
  viabilidade: [
    ...
    // #355: a antiga "Capital Stack" (4 instrumentos com waterfall) virou
    // "Funding" (3 operações independentes). O id/slug mudou junto — a tela
    // foi reescrita do zero, então não há deep link antigo que valha preservar.
