...
const OBRIGATORIOS = [
  ...
  ['.claude/revisao/aprendizados.md', 'o corpo que toda lente lê antes do diff'],
  ['.claude/revisao/retirados.md', 'o registro de falsos positivos — sem ele, o mesmo volta a cada revisão'],
  ['scripts/testar-corpus-revisao.mjs', 'a bateria do corpo — o canal de acúmulo falha sem sintoma'],
