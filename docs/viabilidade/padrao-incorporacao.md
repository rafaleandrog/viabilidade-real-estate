...
> `area_pvt_r_fechada` / `area_pvt_nr_fechada` (`frontend/proforma.ts:268`), convertida por
...
Incorporação é `area_pvt_r_fechada`/`area_pvt_nr_fechada` (`frontend/proforma.ts:268`); a ALV da
