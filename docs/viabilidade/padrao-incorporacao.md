...
>
> `permutaFinanceiraDeduzidaMensal` (`frontend/fluxo-caixa-motor.ts:2023-2037`) **subtrai** cada
...
> condição de nível (`sujeitoRetVisivelFinanceiro`, `frontend/tela-financeiro.ts:110-112`) — a aba só
...
> ✅ **Comportamento vigente (#231, #446).** `calcularFluxo` (`frontend/fluxo-caixa-motor.ts:2273`)
