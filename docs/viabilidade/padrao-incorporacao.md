...
> `area_pvt_r_fechada` / `area_pvt_nr_fechada` (`frontend/proforma.ts:297`), convertida por
...
Incorporação é `area_pvt_r_fechada`/`area_pvt_nr_fechada` (`frontend/proforma.ts:297`); a ALV da
